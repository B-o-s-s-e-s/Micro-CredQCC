...
function startGame() {
  ...
  myGameArea.start();
  //people
  myGamePiece = new component(100, 10, "black", myGameArea.canvas.width / 2 - 50, myGameArea.canvas.height - 20 ,"image");
  //ball
  myball = new component(5, 5, "black", myGameArea.canvas.width / 2 - 2.5 - 100, 110, "image");    
  for (i = 0; i < 68; i++) {
